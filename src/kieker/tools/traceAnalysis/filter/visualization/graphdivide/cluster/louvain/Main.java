...
public class Main {  
    ...
    public static void main(String[] args) throws IOException {  
        ...
        a.init("F:/git-example/Louvain/facebook_combined.txt");
        a.louvain();  
        double endTime = System.currentTimeMillis();  
        //writeOutputJson("/var/www/html/Louvain/miserables.json", a); 
        writeOutputCluster("F:/git-example/Louvain/cluster.txt",a);
        writeOutputCircle("F:/git-example/Louvain/circle.txt",a);
